...
cat_admin1<-catchment_extractor(sample_admin)  # a list of all possible catchment areas in assending order(based on area)


####################################################3
# the biggest catchment area for an admin boundary, sample_admin, will be
catchment_area_sample_admin<- cat_admin1[[1]]
# in many cases multiple catchments could contribute runoff which will endup at an admin boundary therefore it is good to check the 
# other catchment areas in the list cat_admin1 
